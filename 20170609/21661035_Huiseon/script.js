...
//1------------------------김희선
function fnLogin(){
   var objLogin = document.getElementById("username");
   var objuserpass = document.getElementById("userpass");
   ...
   userDisplay.innerHTML = objLogin.value;
   alert("로그인 되었습니다");

   document.getElementById("loginCounter").style.display = "";
}
